...
export default function Frames({ q = new THREE.Quaternion(), p = new THREE.Vector3(), orbitControls, nodes }) {
  const ipadPos = [nodes.Ipad.position.x + 0.02, nodes.Ipad.position.y, nodes.Ipad.position.z]
  const laptopPos = [nodes.LaptopScreen.position.x - 0.25, nodes.LaptopScreen.position.y + 0.25, nodes.LaptopScreen.position.z + 0.365]
